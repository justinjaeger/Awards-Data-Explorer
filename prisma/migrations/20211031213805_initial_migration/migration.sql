/*
  ...
  - You are about to drop the `AwardsBody` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `AwardsCategory` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE `Award` DROP FOREIGN KEY `award_ibfk_1`;

-- DropForeignKey
ALTER TABLE `Award` DROP FOREIGN KEY `award_ibfk_2`;

-- DropForeignKey
ALTER TABLE `Nomination` DROP FOREIGN KEY `nomination_ibfk_2`;

-- DropForeignKey
ALTER TABLE `Nomination` DROP FOREIGN KEY `nomination_ibfk_1`;

-- DropTable
DROP TABLE `Award`;

-- DropTable
DROP TABLE `AwardsBody`;

-- DropTable
DROP TABLE `AwardsCategory`;
