...
exports.Prisma.NominationScalarFieldEnum = makeEnum({
  id: 'id',
  winner: 'winner',
  personId: 'personId',
  movieId: 'movieId'
...
exports.Prisma.AwardsBodyScalarFieldEnum = makeEnum({
  id: 'id',
  name: 'name'
});

exports.Prisma.AwardsCategoryScalarFieldEnum = makeEnum({
  id: 'id',
  name: 'name'
});

exports.Prisma.AwardScalarFieldEnum = makeEnum({
  id: 'id',
  year: 'year',
