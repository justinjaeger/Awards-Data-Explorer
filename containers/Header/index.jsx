...
export default function Header(props) {
    ...
    function deleteUserAndSignUpAgain() {
        ...
        axios
            .post("/api/signup/deleteUser", { email })
            .then((res) => {
                if (res.data.error) return setNotification(res.data.error);
                redirect("/signup");
    ...
    if (notification === "please verify email")
        setNotification([
            <div>Please verify the email sent to: {email}. </div>,
            <button id="notif-click-here" onClick={deleteUserAndSignUpAgain}>
                {" "}
                Incorrect Email?
            </button>,
        ]);
                ...
                {loginDropdown && (
                    ...
                    >
                        <LoginContainer
                            ...
                            reEnterEmailLink={reEnterEmailLink}
                            setReEnterEmailLink={setReEnterEmailLink}
                            changeEmailLink={changeEmailLink}
                            setChangeEmailLink={setChangeEmailLink}
